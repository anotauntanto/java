...
//Variables de configuracón de la recuperación Tweets.
...
// Función manejadora de los Tweets y búsqueda en el Json
...
function handleTweets(tweets){
    ...
    $.getJSON("JSON/Recetas.json",function (json){
        ...
        if (!salir) {
            $("#Titulo").html("Esta receta no se encuentra");
        } else {
...
// Recuperación de la palabra clave.
